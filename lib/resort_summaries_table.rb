class ResortSummariesTable
  ...
  def rows
    rows = []
    @country.resorts.map {|r| [r, r.altitude_m, r.top_lift_m, r.nearest_airport ? r.nearest_airport.name : nil, r.airport_distances.any? ? r.airport_distances.first.distance_km : nil ]}
  end
end
