...
properties = Property.create([
  { :resort_id => 1, :user_id => 1, :name => "Alpen Lounge",      :sleeping_capacity => 6,   :metres_from_lift => 2500, :weekly_rent_price => 1750 },
  { :resort_id => 1, :user_id => 1, :name => "Apartment Teracce", :sleeping_capacity => 8,   :metres_from_lift => 4700, :weekly_rent_price => 2000 },
  { :resort_id => 1, :user_id => 1, :name => "Brigitte's Mazot",  :sleeping_capacity => 2,   :metres_from_lift => 3100, :weekly_rent_price => 1825 },
  { :resort_id => 1, :user_id => 1, :name => "Chalet Alaska",     :sleeping_capacity => 5,   :metres_from_lift => 8300, :weekly_rent_price => 1950 },
  { :resort_id => 1, :user_id => 1, :name => "Chalet Anchorage",  :sleeping_capacity => 10,  :metres_from_lift => 5000, :weekly_rent_price => 1650 },
  { :resort_id => 1, :user_id => 1, :name => "Chalet Arkle",      :sleeping_capacity => 14,  :metres_from_lift => 4000, :weekly_rent_price => 1725 },
  { :resort_id => 1, :user_id => 1, :name => "Chalet Azimuth",    :sleeping_capacity => 8,   :metres_from_lift => 6300, :weekly_rent_price => 2150 },
  { :resort_id => 1, :user_id => 1, :name => "Chalet Bibendum",   :sleeping_capacity => 8,   :metres_from_lift => 5500, :weekly_rent_price => 1350 },
  { :resort_id => 1, :user_id => 1, :name => "Chalet Bornian",    :sleeping_capacity => 8,   :metres_from_lift => 4400, :weekly_rent_price => 1400 },
  { :resort_id => 1, :user_id => 1, :name => "Chalet Chachat",    :sleeping_capacity => 14,  :metres_from_lift => 3500, :weekly_rent_price => 1500 },
  { :resort_id => 1, :user_id => 1, :name => "Chalet Cachemire",  :sleeping_capacity => 20,  :metres_from_lift => 1400, :weekly_rent_price => 1375 },
  { :resort_id => 1, :user_id => 1, :name => "Chalet Chardonnet", :sleeping_capacity => 8,   :metres_from_lift => 9300, :weekly_rent_price => 2000 },
  { :resort_id => 1, :user_id => 1, :name => "Chalet Chintalaya", :sleeping_capacity => 10,  :metres_from_lift => 6500, :weekly_rent_price => 1475 },
  { :resort_id => 1, :user_id => 1, :name => "Chalet Chosalet",   :sleeping_capacity => 8,   :metres_from_lift => 5900, :weekly_rent_price => 2025 },
  { :resort_id => 1, :user_id => 1, :name => "Chalet D'Or",       :sleeping_capacity => 8,   :metres_from_lift => 6000, :weekly_rent_price => 1550 },
  { :resort_id => 1, :user_id => 1, :name => "Chalet des Sapins", :sleeping_capacity => 10,  :metres_from_lift => 4300, :weekly_rent_price => 1650 },
  { :resort_id => 1, :user_id => 1, :name => "Chalet des Isles",  :sleeping_capacity => 12,  :metres_from_lift => 2600, :weekly_rent_price => 1850 },
  { :resort_id => 1, :user_id => 1, :name => "Chalet des Islouts", :sleeping_capacity => 8,  :metres_from_lift => 8500, :weekly_rent_price => 1550 },
  { :resort_id => 1, :user_id => 1, :name => "Chalet Dubrulle",   :sleeping_capacity => 11,  :metres_from_lift => 5000, :weekly_rent_price => 1575 },
  { :resort_id => 1, :user_id => 1, :name => "Chalet Eco-Farm",   :sleeping_capacity => 10,  :metres_from_lift => 7200, :weekly_rent_price => 2100 },
  { :resort_id => 1, :user_id => 1, :name => "Chalet Edelweiss",  :sleeping_capacity => 12,  :metres_from_lift => 4200, :weekly_rent_price => 1900 },
  { :resort_id => 1, :user_id => 1, :name => "Chalet Eftikhia" ,  :sleeping_capacity => 10,  :metres_from_lift => 5900, :weekly_rent_price => 1600 },
  { :resort_id => 1, :user_id => 1, :name => "Chalet Flegere",    :sleeping_capacity => 10,  :metres_from_lift => 3400, :weekly_rent_price => 1700 },
  { :resort_id => 1, :user_id => 1, :name => "Chalet Gauthier",   :sleeping_capacity => 16,  :metres_from_lift => 4300, :weekly_rent_price => 1600 },
  { :resort_id => 1, :user_id => 1, :name => "Chalet Ghia",       :sleeping_capacity => 8,   :metres_from_lift => 6800, :weekly_rent_price => 1450 },
  { :resort_id => 1, :user_id => 1, :name => "Chalet Grassonnets", :sleeping_capacity => 8,  :metres_from_lift => 3500, :weekly_rent_price => 1300 },
  { :resort_id => 1, :user_id => 1, :name => "Chalet Guapa",      :sleeping_capacity => 8,   :metres_from_lift => 4500, :weekly_rent_price => 1800 },
  { :resort_id => 1, :user_id => 1, :name => "Chalet Ibex",       :sleeping_capacity => 10,  :metres_from_lift => 5600, :weekly_rent_price => 1925 },
  { :resort_id => 1, :user_id => 1, :name => "Chalet Jomain",     :sleeping_capacity => 18,  :metres_from_lift => 10200, :weekly_rent_price => 2050 },
  { :resort_id => 1, :user_id => 1, :name => "Chalet Kushi",      :sleeping_capacity => 8,   :metres_from_lift => 9800, :weekly_rent_price => 1500 }
  ])
