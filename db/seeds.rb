...
properties = Property.create([
  { :resort_id => 1, :user_id => 1, :title => "Alpen Lounge",      :sleeps => 6,   :metres_from_lift => 2500, :weekly_rent_price => 1750 },
  { :resort_id => 1, :user_id => 1, :title => "Apartment Teracce", :sleeps => 8,   :metres_from_lift => 4700, :weekly_rent_price => 2000 },
  { :resort_id => 1, :user_id => 1, :title => "Brigitte's Mazot",  :sleeps => 2,   :metres_from_lift => 3100, :weekly_rent_price => 1825 },
  { :resort_id => 1, :user_id => 1, :title => "Chalet Alaska",     :sleeps => 5,   :metres_from_lift => 8300, :weekly_rent_price => 1950 },
  { :resort_id => 1, :user_id => 1, :title => "Chalet Anchorage",  :sleeps => 10,  :metres_from_lift => 5000, :weekly_rent_price => 1650 },
  { :resort_id => 1, :user_id => 1, :title => "Chalet Arkle",      :sleeps => 14,  :metres_from_lift => 4000, :weekly_rent_price => 1725 },
  { :resort_id => 1, :user_id => 1, :title => "Chalet Azimuth",    :sleeps => 8,   :metres_from_lift => 6300, :weekly_rent_price => 2150 },
  { :resort_id => 1, :user_id => 1, :title => "Chalet Bibendum",   :sleeps => 8,   :metres_from_lift => 5500, :weekly_rent_price => 1350 },
  { :resort_id => 1, :user_id => 1, :title => "Chalet Bornian",    :sleeps => 8,   :metres_from_lift => 4400, :weekly_rent_price => 1400 },
  { :resort_id => 1, :user_id => 1, :title => "Chalet Chachat",    :sleeps => 14,  :metres_from_lift => 3500, :weekly_rent_price => 1500 },
  { :resort_id => 1, :user_id => 1, :title => "Chalet Cachemire",  :sleeps => 20,  :metres_from_lift => 1400, :weekly_rent_price => 1375 },
  { :resort_id => 1, :user_id => 1, :title => "Chalet Chardonnet", :sleeps => 8,   :metres_from_lift => 9300, :weekly_rent_price => 2000 },
  { :resort_id => 1, :user_id => 1, :title => "Chalet Chintalaya", :sleeps => 10,  :metres_from_lift => 6500, :weekly_rent_price => 1475 },
  { :resort_id => 1, :user_id => 1, :title => "Chalet Chosalet",   :sleeps => 8,   :metres_from_lift => 5900, :weekly_rent_price => 2025 },
  { :resort_id => 1, :user_id => 1, :title => "Chalet D'Or",       :sleeps => 8,   :metres_from_lift => 6000, :weekly_rent_price => 1550 },
  { :resort_id => 1, :user_id => 1, :title => "Chalet des Sapins", :sleeps => 10,  :metres_from_lift => 4300, :weekly_rent_price => 1650 },
  { :resort_id => 1, :user_id => 1, :title => "Chalet des Isles",  :sleeps => 12,  :metres_from_lift => 2600, :weekly_rent_price => 1850 },
  { :resort_id => 1, :user_id => 1, :title => "Chalet des Islouts", :sleeps => 8,  :metres_from_lift => 8500, :weekly_rent_price => 1550 },
  { :resort_id => 1, :user_id => 1, :title => "Chalet Dubrulle",   :sleeps => 11,  :metres_from_lift => 5000, :weekly_rent_price => 1575 },
  { :resort_id => 1, :user_id => 1, :title => "Chalet Eco-Farm",   :sleeps => 10,  :metres_from_lift => 7200, :weekly_rent_price => 2100 },
  { :resort_id => 1, :user_id => 1, :title => "Chalet Edelweiss",  :sleeps => 12,  :metres_from_lift => 4200, :weekly_rent_price => 1900 },
  { :resort_id => 1, :user_id => 1, :title => "Chalet Eftikhia" ,  :sleeps => 10,  :metres_from_lift => 5900, :weekly_rent_price => 1600 },
  { :resort_id => 1, :user_id => 1, :title => "Chalet Flegere",    :sleeps => 10,  :metres_from_lift => 3400, :weekly_rent_price => 1700 },
  { :resort_id => 1, :user_id => 1, :title => "Chalet Gauthier",   :sleeps => 16,  :metres_from_lift => 4300, :weekly_rent_price => 1600 },
  { :resort_id => 1, :user_id => 1, :title => "Chalet Ghia",       :sleeps => 8,   :metres_from_lift => 6800, :weekly_rent_price => 1450 },
  { :resort_id => 1, :user_id => 1, :title => "Chalet Grassonnets", :sleeps => 8,  :metres_from_lift => 3500, :weekly_rent_price => 1300 },
  { :resort_id => 1, :user_id => 1, :title => "Chalet Guapa",      :sleeps => 8,   :metres_from_lift => 4500, :weekly_rent_price => 1800 },
  { :resort_id => 1, :user_id => 1, :title => "Chalet Ibex",       :sleeps => 10,  :metres_from_lift => 5600, :weekly_rent_price => 1925 },
  { :resort_id => 1, :user_id => 1, :title => "Chalet Jomain",     :sleeps => 18,  :metres_from_lift => 10200, :weekly_rent_price => 2050 },
  { :resort_id => 1, :user_id => 1, :title => "Chalet Kushi",      :sleeps => 8,   :metres_from_lift => 9800, :weekly_rent_price => 1500 }
  ])
